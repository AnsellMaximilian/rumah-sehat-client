...
const DrMyDeliveryIndex = () => {
  ...
  const handleDelete = (id) => {
    (async () => {
      try {
        await http.delete(`/dr/my/deliveries/${id}`);
  ...
  useEffect(() => {
    (async () => {
      setDeliveries((await http.get("/dr/my/deliveries")).data.data);
  ...
  const handleFilter = async () => {
    ...
    setDeliveries(
      (await http.get(`/dr/my/deliveries?${queryParams}`)).data.data
    );
  };
      ...
      renderCell: (params) => {
        return (
          <>
            ...
            <IconButton
              component={Link}
              to={`/dr/my/deliveries/${params.row.id}`}
              color="primary"
            >
              <ShowIcon />
            </IconButton>
...
export default DrMyDeliveryIndex;
