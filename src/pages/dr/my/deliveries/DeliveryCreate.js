...
export default function DrMyDeliveryCreate({ edit }) {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (edit) {
        if (items.length > 0) {
          const delivery = (await http.get(`/dr/my/deliveries/${id}`)).data
            .data;
          setDeliveryDetails(
  ...
  const onSubmit = async (d) => {
    try {
      ...
      if (!edit) {
        ...
        navigate("/dr/my/deliveries");
        toast.success("Created delivery.");
      } else {
        await http.patch(`/dr/my/deliveries/${id}`, body);
        navigate(`/dr/my/deliveries/${id}`);
            ...
            <TableBody>
                ...
                >
                  ...
                  <TableCell align="right">
                    <TextField
                      ...
                      onChange={handleDetailAttrChange("priceRM", detail.key)}
                    />
                  </TableCell>
                  ...
                  <TableCell align="right">
                    <NumericFormatRM value={detail.item.priceRM * detail.qty} />
                  </TableCell>
                </TableRow>
              ))}
              <TableRow>
                ...
                <TableCell align="right">
                  <NumericFormatRM
                    value={getSubtotal(deliveryDetails, "priceRM")}
                  />
                </TableCell>
              </TableRow>
              {useDiscount && (
              ...
              <TableRow>
                ...
                <TableCell align="right" colSpan={3}>
                  <NumericFormatRM
                    value={
                      getSubtotal(deliveryDetails, "priceRM") * exchangeRate +
                      (deliveryCostType === "individual"
