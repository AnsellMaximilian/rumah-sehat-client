  ...
  return (
    <Paper sx={{ paddingBottom: 2 }}>
      ...
      <Collapse in={isOpen}>
        <Table
          size="small"
          rows={delivery.DrIdDeliveryDetails}
          columns={[
            getTableColumn("Item", "itemName"),
            getTableColumn("Points", "points"),
            getTableColumn("Price", "priceRP", (row) => (
              <NumericFormatRp value={parseFloat(row.priceRP)} />
            )),
            ...
            <>
              <TableRow>
                ...
                <TableCell align="right">
                  <NumericFormatRp value={parseInt(delivery.subtotalPriceRP)} />
                </TableCell>
              </TableRow>
