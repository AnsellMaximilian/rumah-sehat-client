  ...
  return (
    <Paper sx={{ paddingBottom: 2 }}>
      ...
      <Collapse in={isOpen}>
        <Table
          size="small"
          rows={delivery.DrSgDeliveryDetails}
          columns={[
            ...
            getTableColumn(
              "Price",
              "priceSGD",
              (row) => <NumericFormatSGD value={parseFloat(row.priceSGD)} />,
            ...
            getTableColumn(
              ...
              "totalPriceSGD",
              (row) => (
                <NumericFormatSGD value={parseFloat(row.totalPriceSGD)} />
              ),
              { align: "right" }
            ),
          ]}
          tableBottom={
            <>
              <TableRow>
                ...
                <TableCell align="right">
                  <NumericFormatRp
                    value={parseInt(delivery.subtotalPriceSGD)}
                  />
                </TableCell>
              </TableRow>
              <TableRow>
